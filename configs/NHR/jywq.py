...
basedir = '/home/vrlab/workspace/NCVV/NCVV/logs/NHR/'
half_res = True
...
density_deform=True
data = dict(
    # datadir='/data/new_disk3/wangla/Dataset/dome/jywq',
    datadir='/home/vrlab/workspace/NCVV/NCVV/logs/NHR/jywq_2_250',
    dataset_type='NHR',
    inverse_y=True,
    white_bkgd=True,
)
